...
class Elem:
    ...
    def face_center(self, i):
        ...
        if i == 0:
            ...
            print(f"Invalid face number {i} (must be between 0 and 5)")
...
class HexaData:
        ...
        for (iel, el), ibc, iface in product(
            ...
            if cbc == "E" or cbc == "P":
                ...
                if connected_iel < 0 or connected_iel >= self.nel:
                    ...
                    print(f"face center: ({xc:.6e} {yc:.6e} {zc:.6e})")
                else:
    ...
    def merge(self, other, tol=1e-2, ignore_empty=True, ignore_all_bcs=False):
        ...
        if nbc == 0 or ignore_all_bcs:
            ...
            print("no pairs of faces to merge")
            return nchanges
        ...
        print(f"merged {nchanges} pairs of faces")
        return nchanges
